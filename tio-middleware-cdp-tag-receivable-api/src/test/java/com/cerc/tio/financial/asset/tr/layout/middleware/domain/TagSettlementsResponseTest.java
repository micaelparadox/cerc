...
class TagSettlementsResponseTest {
    ...
    void serializeToJson_shouldSerializeCorrectly() throws Exception {
        ...
        TagSettlementsResponse response = TagSettlementsResponse.builder()
    ...
    void deserializeFromJson_shouldDeserializeCorrectly() throws Exception {
        ...
        // when
        TagSettlementsResponse response = mapper.readValue(json, TagSettlementsResponse.class);
